...
export const users = pgTable('users', {
  ...
  freeTokensResetAt: timestamp('free_tokens_reset_at', { withTimezone: true }).notNull().defaultNow(),
...
export const usageLog = pgTable(
  ...
  (t) => ({ ownerCreatedIdx: index('usage_log_owner_created_idx').on(t.ownerId, t.createdAt) }),
);

export const schema = { users, maps, nodes, edges, usageLog };
