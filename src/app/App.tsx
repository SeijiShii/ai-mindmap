...
export function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/map/:id" element={<main className="p-4">キャンバス</main>} />
      <Route path="/legal/privacy" element={<main className="p-4">プライバシーポリシー</main>} />
      <Route path="/legal/terms" element={<main className="p-4">利用規約</main>} />
      <Route
        path="/legal/specified-commercial-transactions"
        element={<main className="p-4">特定商取引法に基づく表記</main>}
      />
      <Route path="*" element={<main className="p-4">ページが見つかりません</main>} />
    </Routes>
  );
}
      ...
      <MemoryRouter initialEntries={[initialPath]}>
        <div className="flex min-h-screen flex-col">
          <AppHeader
            ...
            actions={<InfoButton>会議を聞きながら AI と往復で考えをほどくマインドマップです。</InfoButton>}
          />
